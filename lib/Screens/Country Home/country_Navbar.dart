...
class CountryNavBar extends StatefulWidget {
  @override
  _CountryNavBarState createState() => _CountryNavBarState();
}

class _CountryNavBarState extends State<CountryNavBar> {
  ...
  final _indexPage = [CountryHome(), Courses(), Wishlist(), Profile()];
