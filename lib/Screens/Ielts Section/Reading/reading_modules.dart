...
import 'package:esooul/Screens/Ielts%20Section/Reading/reading_test.dart';
            ...
            GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => AboutReading()));
                },
                child: moduleCard(
                    context, 'assets/png/listning.png', 'About Reading test')),

            GestureDetector(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => ReadingTestInstructions()));
                },
