                ...
                style: TextStyle(color: Colors.black, fontSize: 10),
                       ...
                       bulletCard(context, 'What did Jones (2014) assert?'),
                          ...
                          myText(context, 'Forming the Simple Past'),
                             snapshot(context,'assets/png/grammer18.PNG'),
                          myText(context, 'In affirmative sentences the word order is subject + verb and the form of the verb in the simple past is the same for all subjects (with the exception of ‘to be’ – was/were).'),
                          myText(context, 'Subject + past simple + object'),
                          myText(context, 'For example:'),
                          myText(context, 'I played football yesterday.'),
                          myText(context, 'He saw his family last week.'),
                          myText(context, 'I was in France in June.'),myHeading(context, 'Negative sentences in the Simple Past'),
                          myText(context, 'To make negative negative sentences in the simple past we use the auxiliary ‘did not’ / ‘didn’t’ and the base form of the verb. '),
                          myText(context, 'Subject + did not + base form of verb + object'),
                          myText(context, 'For example:'),
                          myText(context, 'I didn’t play football yesterday.'),
                          myText(context, 'They didn’t go to the theater last month.'),
                          myText(context, 'She didn’t arrive on time this morning.'),
                          myHeading(context,'Questions in the Simple Past'),
                          myText(context, 'To make questions in the simple past we use ‘did’ in front of the subject and base form of the verb.'),
                          myText(context, 'Did + subject + base form of verb + object?'),
                          myText(context, 'For example:'),
                          myText(context, 'Did you play football yesterday?'),
                          myText(context, 'Did they lose the match?'),
                          myText(context, 'Did he clean his home last weekend?'),
                          myHeading(context,'Regular and Irregular Verbs'),
                          myText(context, 'In order to convert regular verbs from their base form to the simple past form, we add -ed. For irregular verbs, however, the simple past form doesn’t follow this rule and can vary significantly and you simply need to learn them by heart. There are many irregular verbs but below you can find the most common ones that you need to know for daily use.'),
                          myHeading(context,'Regular verb examples'),
                          bulletCard(context, 'place – placed'),
                          bulletCard(context, 'dance – danced'),
                          bulletCard(context, 'plan – planned'),
                          bulletCard(context, 'stop – stopped'),
                          bulletCard(context, 'fix – fixed'),
                          bulletCard(context, 'snow – snowed'),
                          bulletCard(context, 'rain – rained'),
                          bulletCard(context, 'need – needed'),
                          bulletCard(context, 'help – helped'),
                          bulletCard(context, 'add – added'),
                          bulletCard(context, 'worry – worried'),
                          bulletCard(context, 'play – played'),
                          myText(context, 'As you can see from these examples, with most regular verbs we add -ed. When a verb ends in -e we simply add -d. And when a verb ends in a consonant and -y, we change the -y to -i and add -ed.'),
myHeading(context,'Irregular verb examples'),
                          bulletCard(context, 'be – was/were'),
                          bulletCard(context, 'buy – bought'),
                          bulletCard(context, 'come – came'),
                          bulletCard(context, 'do – did'),
                          bulletCard(context, 'eat – ate'),
                          bulletCard(context, 'find – found'),
                          bulletCard(context, 'go – went'),
                          bulletCard(context, 'have – had'),
                          bulletCard(context, 'leave – left'),
                          bulletCard(context, 'make – made'),
                          bulletCard(context, 'pay – paid'),
                          bulletCard(context, 'see – saw'),
                          bulletCard(context, 'take – took'),
                          bulletCard(context, 'tell – told'),
                          bulletCard(context, 'write – wrote'),
                          myText(context, ''),
                         myHeading(context, '- Pronouns'),
                          myText(context, 'A pronoun is a word that is used instead of a noun or noun phrase. Pronouns refer to either a noun that has already been mentioned or to a noun that does not need to be named specifically'),
                          myText(context, 'The most common pronouns are the personal pronouns, which refer to the person or people speaking or writing (first person), the person or people being spoken to (second person), or other people or things (third person). Like nouns, personal pronouns can function as either the subject of a verb or the object of a verb or preposition: "She likes him, but he loves her." Most of the personal pronouns have different subject and object forms:'),
                          snapshot(context, 'assets/png/grammer19.PNG'),
                          snapshot(context, 'assets/png/grammer20.PNG'),
                          myText(context, 'There are a number of other types of pronouns. The interrogative pronouns—particularly what, which, who, whom, and whose—introduce questions for which a noun is the answer, as in "Which do you prefer?"'),
                          myText(context, 'Possessive pronouns refer to things or people that belong to someone. The main possessive pronouns are mine, yours, his, hers, its, ours, and theirs.'),
                          myText(context, 'The four demonstrative pronouns—this, that, these, and those—distinguish the person or thing being referred to from other people or things; they are identical to the demonstrative adjectives.'),
                          myText(context, 'Relative pronouns introduce a subordinate clause, a part of a sentence that includes a subject and verb but does not form a sentence by itself. The main relative pronouns are that, which, who, whom, what, and whose.'),
                          myText(context, 'Reflexive pronouns refer back to the subject of a sentence or clause and are formed by adding -self or -selves to a personal pronoun or possessive adjective, as in myself, herself, ourselves, and itself.'),
                          myText(context, 'Indefinite pronouns, such as everybody, either, none, and something, do not refer to a specific person or thing, and typically refer to an unidentified or unfamiliar person or thing.'),
                          myText(context, 'The words it and there can also be used like pronouns when the rules of grammar require a subject but no noun is actually being referred to. Both are usually used at the beginning of a sentence or clause, as in "It was almost noon" and "There is some cake left." These are sometimes referred to as expletives.'),
                          myHeading(context, '- Relative Clauses'),
                          myText(context, 'This is a clause that generally modifies a noun or a noun phrase and is often introduced by a relative pronoun (which, that, who, whom, whose). A relative clause connects ideas by using pronouns that relate to something previously mentioned and allows the writer to combine two independent clauses into one sentence. A relative clause is also known as an adjective clause. There are two types of relative clauses: restrictive and nonrestrictive.'),
                          myText(context, 'Here are a few examples:'),
                          bulletCard(context, 'The book that she read was important for her literature review. (restrictive)'),
                          bulletCard(context, 'The participants who were interviewed volunteered to be part of the study. (restrictive)'),
                          bulletCard(context, 'Walden University, which is entirely online, has main administrative offices in Baltimore and Minneapolis. (nonrestrictive)'),
                         myHeading(context, 'Relative Pronouns'),
                           snapshot(context, 'assets/png/grammer21.PNG'),

                          myText(context, '* In APA 7, per Section 4.19, use "who" or "whom" instead of "that" when referring to a human.'),
                          myText(context, '** Although both "which" and "that are grammatically correct in restrictive clauses, APA prefers "that" for restrictive clauses. See APA 7, Sections 4.19-4.21 for more information on this topic.'),
                          bulletCard(context, 'Take this quiz on Grammar Diagnostic Quiz to test your understanding of relative pronouns.'),
                          bulletCard(context, 'Use relative clauses to create more sentence variety.'),
                          myHeading(context,'Restrictive Clause'),
                          myText(context, 'A restrictive clause restricts or defines the meaning of a noun or noun phrase and provides necessary information about the noun in the sentence. It is not separated from the rest of the sentence by commas. Restrictive clauses are more common in writing than nonrestrictive clauses. A restrictive clause is also sometimes referred to as an essential clause or phrase.'),
                          myText(context, 'Here are a few examples:'),

                          bulletCard(context, 'The student who sits in the back of the room asks a lot of questions.'),
                          bulletCard(context, 'The results that I obtained may invoke positive social change.'),
                          bulletCard(context, 'The journalist whose story I read yesterday has won prizes for her work.'),

                          myText(context, 'When the relative pronoun functions as the object of the sentence, it can (and usually is) omitted from the relative clause.'),
                          myText(context, 'Here are a few examples:'),

                          bulletCard(context, 'The results that I obtained may invoke positive social change.'),
                          bulletCard(context, 'The article that I requested did not arrive on time.'),
                          bulletCard(context, 'The participants who I interviewed met me at the local library.'),

                          myHeading(context, 'Nonrestrictive Clause'),
                          myText(context, 'A nonrestrictive clause adds additional information to a sentence. It is usually a proper noun or a common noun that refers to a unique person, thing, or event. It uses commas to show that the information is additional. The commas almost act like parentheses within the sentence. If the information between the commas is omitted, readers will still understand the overall meaning of the sentence. A nonrestrictive clause is also known as a nonessential clause or phrase.'),
                          myText(context, 'Here are a few examples:'),
                          bulletCard(context, 'I want to thank my father, Mark Smith, for all of his love and support.'),
                          bulletCard(context, 'With the nonrestrictive clause omitted: I want to thank my father for all of his love and support'),
                          bulletCard(context, 'The hypothesis, which I tested throughout the research, was rejected.'),
                          bulletCard(context, 'With the nonrestrictive clause omitted: The hypothesis was rejected.'),
                          bulletCard(context, 'I have found the article, which I have been looking for.'),
                          bulletCard(context, 'With the nonrestrictive clause omitted: I have found the article.'),

                          myText(context, 'Although "that" is sometimes used in restrictive clauses, it is not allowed in nonrestrictive clauses.'),
                          bulletCard(context, 'CORRECT: Minneapolis, which has a population of about 400,000, is the largest city in Minnesota.'),
                          bulletCard(context, 'INCORRECT: Minneapolis, that has a population of about 400,000, is the largest city in Minnesota.'),
                          bulletCard(context, 'CORRECT: I had to fix my printer, which I bought less than a year ago.'),
                          bulletCard(context, 'INCORRECT: I had to fix my printer, that I bought less than a year ago.'),

                          myText(context, 'A relative pronoun cannot be deleted in a nonrestrictive clause.'),
                          bulletCard(context, 'CORRECT: Minneapolis, which has a population of about 400,000, is the largest city in Minnesota.'),
                          bulletCard(context, 'INCORRECT: Minneapolis, has a population of about 400,000, is the largest city in Minnesota.'),
                          bulletCard(context, 'CORRECT: I had to fix my printer, which I bought less than a year ago.'),
                          bulletCard(context, 'INCORRECT: I had to fix my printer, I bought less than a year ago.'),

                          myText(context, 'In academic writing, relative clauses are often reduced for a more concise style. This also creates more sentence variety. When reducing a relative clause, it is necessary to delete the relative pronoun and either delete or change the verb. Here are some examples:'),
                          bulletCard(context, 'Gun control is a controversial issue that is about personal rights. ("be" + prepositional phrase)'),
                          bulletCard(context, 'The steps that were followed were explained in the Methods section. (passive)'),
                          bulletCard(context, 'Other researchers who are exploring the same topic have discovered similar solutions. (progressive verb tense)'),
                          bulletCard(context, 'Participants who were available to meet in my office completed their interview there. ("be" + "-able" adjective)'),
                          bulletCard(context, 'Some of the subjects lived in urban areas that had with high crime rates. ("have" as a main verb is replaced by "with")'),
                          bulletCard(context, 'In this paper, I reviewed many research articles that addressed addressing the topic of gun control. (linking verbs or verbs describing facts can be changed to "–ing" clauses)'),
                          bulletCard(context, 'The changes that are to be implemented with the new curriculum revisions are outlined in the handout. ("to" clauses)'),
