...
import 'package:esooul/Screens/Ielts%20Section/Speaking/speaking_test.dart';
            ...
            GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => AboutSpeaking()));
                },
                child: moduleCard(
                    context, 'assets/png/listning.png', 'About Speaking test')),

            GestureDetector(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          WritingTestInstruction(instruction: "")));
                },
