...
class StreetMarket extends StatefulWidget {
  StreetMarket({Key? key}) : super(key: key);

  @override
  _StreetMarketState createState() => _StreetMarketState();
}

class _StreetMarketState extends State<StreetMarket> {
  @override
  Widget build(BuildContext context) {
    List part1List = SpeakingData.part2Test2;
    return Scaffold(
      body: Container(
        child: Column(
          children: [
