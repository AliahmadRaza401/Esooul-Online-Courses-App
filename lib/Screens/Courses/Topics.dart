...
class _TopicsState extends State<Topics> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 18,color: Color(0xff1D6CA7)),
                      )
                  ...
                  Wrap(
                    children:[
                      ...
                      bullets("",'Instructions : Four possible answers A, B, C and D to each question are given. The choice which you think is correct, fill that circle in front of that question with Marker or Pen ink in the answer-book.Cutting or filling two or more circles will result in zero mark in that question.'),
  ...
  Widget bullets(String bullet, String txt) {
    return Row(
      ...
      children: [
        Text("$bullet",style: TextStyle(color: Colors.black,fontSize: 30),),
        SizedBox(
