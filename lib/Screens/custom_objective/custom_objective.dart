...
class CustomObjective extends StatefulWidget {
  const CustomObjective({Key? key}) : super(key: key);

  @override
  _CustomObjectiveState createState() => _CustomObjectiveState();
}

class _CustomObjectiveState extends State<CustomObjective> {
  bool _loader = true;
  var selectedOption;
  ...
  int attemped = 0;
  int notAttemped = 0;
  late CustomObjectiveProvider _customObjectiveProvider;
  ...
  void initState() {
    super.initState();
    _customObjectiveProvider = Provider.of(context, listen: false);
