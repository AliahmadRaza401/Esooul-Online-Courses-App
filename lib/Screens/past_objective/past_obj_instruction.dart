...
class PastObjectiveInstruction extends StatefulWidget {
  const PastObjectiveInstruction({Key? key}) : super(key: key);

  @override
  _PastObjectiveInstructionState createState() => _PastObjectiveInstructionState();
}

class _PastObjectiveInstructionState extends State<PastObjectiveInstruction> {
